...
export default function GapAnomalyDetection() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-anomaly-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Anomaly Detection</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>(unusual delivery patterns)</p>
