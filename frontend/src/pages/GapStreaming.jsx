...
// Streaming
// Streaming anomaly detection for failed attempts and driver behavior
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming anomaly detection for failed attempts and driver behavior</p>
