...
// Carbon
// Carbon impact tracker with offset integration

export default function GapCarbon() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-carbon', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Carbon</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Carbon impact tracker with offset integration</p>
