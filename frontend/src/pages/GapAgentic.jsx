...
// Agentic
// Agentic delivery planner with real-time re-routing on traffic/weather/failures
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic delivery planner with real-time re-routing on traffic/weather/failures</p>
