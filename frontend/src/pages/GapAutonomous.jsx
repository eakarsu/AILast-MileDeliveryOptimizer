...
// Autonomous
// Autonomous customer comms agent (proactive delay notifications)
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous customer comms agent (proactive delay notifications)</p>
