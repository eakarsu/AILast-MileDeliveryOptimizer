...
// Feature: Customer
// Description: Customer SMS/email comms beyond internal notifications
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Customer. Customer SMS/email comms beyond internal notifications' },
