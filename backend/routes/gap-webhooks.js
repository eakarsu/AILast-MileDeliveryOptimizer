...
// Feature: Webhooks
// Description: Webhooks for 3PL integration (Flexport, Shippo)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Webhooks. Webhooks for 3PL integration (Flexport, Shippo)' },
